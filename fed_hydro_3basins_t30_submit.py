...
from dataset import MNIST, CIFAR, SimLin, TimeSeries, HydroDataSet, HydroDataSet1
...
if __name__ == '__main__':
    ...
    nodes = PSGD.parse_worker(worker_cnt=3, ps=True, filename="worker.json")
    for i in range(1):
        try:
            job.parallel(nodes, codec=worker[i], epoch=5, op_type=nn.optimizer.ParameterAveragingOptimizer,
