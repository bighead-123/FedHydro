...
class LSTM(AbsLayer):
    ...
    def __init__(self, n_in, units,  nb_seq, h0=None, c0=None, forget_bias_num=1, return_sequence=False,
    ...
    def forward(self, input):
        ...
        self.__h0 = self.__zeros((nb_batch, n_out)) if h0 is None else h0
        ...
        for t in range(nb_seq):
            ...
            prevh = Hout[t - 1] if t > 0 else self.__h0
            # bias
            Hin[t, :, 0] = 1
            Hin[t, :, 1:n_in + 1] = input[t]  # 输入x
            Hin[t, :, n_in + 1:] = prevh  # preh
