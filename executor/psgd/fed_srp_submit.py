...
from executor.psgd.fed_meta_worker import PSGDMetaWorkerExecutor
from executor.psgd.fed_srp_worker import PSGDFedSRPWorkerExecutor
...
class FedSRPParallelSGD:
    ...
    def parallel(self,
        ...
        with req.request(nodes) as com:
            ...
            coordinator.submit_group(PSGDFedSRPWorkerExecutor, assignment.nodes, self.__data.estimate_size())
