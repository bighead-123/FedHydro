...
from executor.federated_learning.fed_net_package import IPSGDOpContainer, misc_package, Requests, Req
from executor.federated_learning.fed_net_package import net_model, net_setting
from models import RequestPackage, IRequestPackage
from network import ICommunication_Controller
from nn import IModel
from nn.data import SimpleDataFeeder
...
class FedPSGDWorkerExecutor(AbsExecutor):
    ...
    def start(self, com: ICommunication_Controller) -> None:
        ...
        feeder = SimpleDataFeeder(train_x, train_y, batch_iter=self.__batch_iter, block_ids=block_ids)
        # assemble optimizer
