...
class net_optimizer(IReplyPackage, IPSGDOpContainer):
    ...
    def __init__(self, optimizer_type: Type[IOptimizer], gradient_method: Type[IGradientDescent], op_params: Sequence[tuple] = tuple()):
    ...
    def optimize(self, *variables: ITrainable):
        ...
        for var in variables:
            self.__ops.append(self.__op(
                gradient_descent=self.__gd(*(self.__op_params[i])),
